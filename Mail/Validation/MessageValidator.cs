...
public class MessageValidator : AbstractValidator<Message>
{
    public MessageValidator()
    {
        ...
        RuleFor(message => message.Html)
            .NotEmpty()
            .When(message => string.IsNullOrEmpty(message.Text) && message.Template is null)
            .WithMessage("{PropertyName} field is required since Text and Template field is not provided");
        
        RuleFor(message => message.Text)
            .NotEmpty()
            .When(message => string.IsNullOrEmpty(message.Html) && message.Template is null)
            .WithMessage("{PropertyName} field is required since Html and Template field is not provided");
        
        RuleFor(message => message.Template)
            .NotEmpty()
            .When(message => string.IsNullOrEmpty(message.Html) && string.IsNullOrEmpty(message.Text))
            .WithMessage("{PropertyName} field is required since Html and Text field is not provided");
